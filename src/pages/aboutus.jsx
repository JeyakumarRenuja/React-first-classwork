          ...
          <div className="main-content">
            <div className="row">
              ...
              <div className="col-lg-6">
                ...
                <p classNameName="more-info">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod tempor incididunt ut labore et dolore dolor dolor sit amet, consectetur adipiscing elit, sed doers eiusmod.</p>
              </div>
            </div>
          </div>
        </div>
